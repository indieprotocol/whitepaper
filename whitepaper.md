...
The end users of the digital media content will not necessarily have an account at the Indie Protocol network for the specific content they are using, so interactions and likes are completely distribution platform dependent. They will then submit those statistics back to Indie Protocol, just for display and sorting purposes, but not have any weight in the rewards.
